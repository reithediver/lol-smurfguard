...
class OpggMcpClient {
    constructor() {
        ...
        this.MCP_SERVER_URL = 'https://mcp-api.op.gg/mcp/sse';
        // Initialize SSE transport for OP.GG MCP server
        this.transport = new sse_js_1.SSEClientTransport(new URL(this.MCP_SERVER_URL));
     ...
     */
    transformMcpDataToEnhancedAnalysis(summonerData, matchHistory, championStats, summonerName, region) {
        try {
     ...
     */
    generateMockAnalysis(summonerName, region) {
        return {
            summoner: {
                name: summonerName,
...
exports.OpggMcpClient = OpggMcpClient;
